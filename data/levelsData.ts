    ...
    questions: [
      {
        ...
        imageUrl: "/images/quiz/soal_batik.png",
        aiContext: "Pola C butuh 8 tembereng, 5 kuning, 4 besar coklat, sehingga kertas Tina cukup. Pola A dan B kurang bahannya.",
        choices: [
          { value: "A", label: "Pola A", choiceImageUrl: "/images/quiz/batik_a.png" },
          { value: "B", label: "Pola B", choiceImageUrl: "/images/quiz/batik_b.png" },
          { value: "C", label: "Pola C", choiceImageUrl: "/images/quiz/batik_c.png" },
      ...
      },
      {
        ...
        imageUrl: "/images/quiz/soal_tombolhewan.png",
        aiContext: "Polanya berputar: Kanan -> Bawah -> Kiri -> Atas. Posisi akhir ada di Opsi C.",
        choices: [
          { value: "A", label: "Opsi A", choiceImageUrl: "/images/quiz/hewan_a.png" },
          { value: "B", label: "Opsi B", choiceImageUrl: "/images/quiz/hewan_b.png" },
          { value: "C", label: "Opsi C", choiceImageUrl: "/images/quiz/hewan_c.png" },
          { value: "D", label: "Opsi D", choiceImageUrl: "/images/quiz/hewan_d.png" }
        ],
        correctAnswer: "C",
      ...
      },
      {
        ...
        imageUrl: "/images/quiz/soal_selendang.png",
        ...
        choices: [
          { value: "A", label: "Opsi A", choiceImageUrl: "/images/quiz/tari_a.png" },
          { value: "B", label: "Opsi B", choiceImageUrl: "/images/quiz/tari_b.png" },
          { value: "C", label: "Opsi C", choiceImageUrl: "/images/quiz/tari_c.png" },
          { value: "D", label: "Opsi D", choiceImageUrl: "/images/quiz/tari_d.png" }
        ],
        correctAnswer: "B",
    ...
    questions: [
      {
        ...
        imageUrl: "/images/quiz/soal_gelang.png",
        aiContext: "Gelang C salah karena memiliki 2 manik love yang berjejeran berurutan, melanggar aturan awal.",
        choices: [
          { value: "A", label: "Gelang A", choiceImageUrl: "/images/quiz/gelang_a.png" },
          { value: "B", label: "Gelang B", choiceImageUrl: "/images/quiz/gelang_b.png" },
          { value: "C", label: "Gelang C", choiceImageUrl: "/images/quiz/gelang_c.png" },
          { value: "D", label: "Gelang D", choiceImageUrl: "/images/quiz/gelang_d.png" }
        ],
        correctAnswer: "C",
      ...
      },
      {
        ...
        imageUrl: "/images/quiz/soal_snack.png",
        aiContext: "Opsi D memenuhi semuanya. Opsi A (cokelat nempel), Opsi B (tanpa keju), Opsi C (3 cokelat).",
        choices: [
          { value: "A", label: "Buket A", choiceImageUrl: "/images/quiz/snack_a.png" },
          { value: "B", label: "Buket B", choiceImageUrl: "/images/quiz/snack_b.png" },
          { value: "C", label: "Buket C", choiceImageUrl: "/images/quiz/snack_c.png" },
          { value: "D", label: "Buket D", choiceImageUrl: "/images/quiz/snack_d.png" }
        ],
        correctAnswer: "D",
      ...
      },
      {
        ...
        imageUrl: "/images/quiz/soal_simbol.png",
        aiContext: "Opsi A salah karena penambahan lambangnya tidak simetris (kiri 4, kanan 5).",
        choices: [
          { value: "A", label: "Opsi A", choiceImageUrl: "/images/quiz/label_a.png" },
          { value: "B", label: "Opsi B", choiceImageUrl: "/images/quiz/label_b.png" },
          { value: "C", label: "Opsi C", choiceImageUrl: "/images/quiz/label_c.png" },
          { value: "D", label: "Opsi D", choiceImageUrl: "/images/quiz/label_d.png" }
        ],
        correctAnswer: "A",
    ...
    questions: [
      {
        ...
        imageUrl: "/images/quiz/soal_sandi.png",
      ...
      },
      {
        ...
        imageUrl: "/images/quiz/soal_kebun.png",
      ...
      },
      {
        ...
        choices: [
          ...
          { value: "B", label: "Opsi B", choiceImageUrl: "/images/quiz/robot_b.png" },
          { value: "C", label: "Opsi C", choiceImageUrl: "/images/quiz/robot_c.png" },
          { value: "D", label: "Opsi D", choiceImageUrl: "/images/quiz/robot_d.png" }
        ],
        correctAnswer: "D",
    ...
    questions: [
      {
        ...
        imageUrl: "/images/quiz/soal_lompat.png",
      ...
      },
      {
        ...
        imageUrl: "/images/quiz/soal_rute_kelinci.png",
    ...
    questions: [
      {
        ...
        imageUrl: "/images/quiz/soal_panda.png",
      ...
      },
      {
        ...
        imageUrl: "/images/quiz/soal_balon.png",
      ...
      },
      {
        ...
        imageUrl: "/images/quiz/soal_sawah.png",
